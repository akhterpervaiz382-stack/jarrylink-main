...
# Aapki branding aur Blogger dono ko allow kiya gaya hai
...
def redirect_logic(short_code):
    # System files ko ignore karne ke liye
    ...
    try:
        ...
        if res.data and len(res.data) > 0:
            ...
            # Clicks update karna (Background mein)
            try:
            ...
            # --- ASLI DIRECT REDIRECT LOGIC ---
            response = make_response("", 302)
            response.headers['Location'] = target
            # Cache khatam taake direct redirection har baar refresh ho
